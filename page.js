...
export default function PokemonReportsPage() {
  ...
  const catchThemAll = async () => {
    ...
    try {
      ...
      await createReport(selectedType, maxRecords ? Number(maxRecords) : undefined)
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <label htmlFor="maxRecords" className="block mb-1 font-semibold">
            ...
            <input
              ...
              onChange={e => {
                ...
                // Permitir solo enteros positivos o vacío
